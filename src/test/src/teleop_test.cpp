...
if(cmd[0]=='a'){ 
  ...
  while(temps-- > 0){
    base_cmd.linear.x=vitesse;
    printf("vitesse est :%f\t",vitesse);
    printf("temps est: %f\n",temps);
...
/*void RobotAvanceDistance(int distance)
{
  ros::Publisher cmd_vel_pub_;
  //we will be sending commands of type "twist"  
  geometry_msgs::Twist base_cmd;
